...
par(mfrow = c(2, 2))
with(data, {
        plot(DateTime, Global_active_power, lines(DateTime,Global_active_power), 
             pch = NA, xlab = NA, ylab = "Global Active Power")
        ...
        legend("topright", bty = "n", lty=1,lwd=2, col = c("black", "blue", "red"), 
